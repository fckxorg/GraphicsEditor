...
CREATE(pencil_button_sprite, Sprite,
       Texture("icons/pencil.png", EDITOR_BUTTON_SIZE), Position(15, 910));
CREATE(eraser_button_sprite, Sprite,
       Texture("icons/eraser.png", EDITOR_BUTTON_SIZE), Position(15, 980));
CREATE(save_button_sprite, Sprite,
       Texture("icons/save.png", EDITOR_BUTTON_SIZE), Position(1515, 15));
CREATE(brush_button_sprite, Sprite,
       Texture("icons/brush.png", EDITOR_BUTTON_SIZE), Position(85, 910));
...
CREATE(spray_button_sprite, Sprite, Texture("icons/spray.png", Size(50, 50)),
       Position(155, 910));
CREATE(clear_button_sprite, Sprite,
       Texture("icons/clear.png", EDITOR_BUTTON_SIZE), Position(155, 980));
CREATE(rect_button_sprite, Sprite,
       Texture("icons/rectangular.png", EDITOR_BUTTON_SIZE),
       Position(225, 910));
...
CREATE(eraser_button_outline, RectWindow, EDITOR_BUTTON_OUTLINE_SIZE,
       Position(10, 975), OUTLINE_COLOR);
...
CREATE(sv_selector_outline, RectWindow, Size(370, 370), Position(1540, 630),
       OUTLINE_COLOR);
CREATE(save_button_outline, RectWindow, EDITOR_BUTTON_OUTLINE_SIZE,
       Position(1510, 10), OUTLINE_COLOR);
CREATE(brush_button_outline, RectWindow, EDITOR_BUTTON_OUTLINE_SIZE,
       Position(80, 905), OUTLINE_COLOR);
CREATE(dropper_button_outline, RectWindow, EDITOR_BUTTON_OUTLINE_SIZE,
       Position(80, 975), OUTLINE_COLOR);
CREATE(spray_button_outline, RectWindow, EDITOR_BUTTON_OUTLINE_SIZE,
       Position(150, 905), OUTLINE_COLOR);
CREATE(clear_button_outline, RectWindow, EDITOR_BUTTON_OUTLINE_SIZE,
       Position(150, 975), OUTLINE_COLOR);
CREATE(rect_button_outline, RectWindow, EDITOR_BUTTON_OUTLINE_SIZE,
...
CREATE(hue_slider, HueSlider, Size(3, 30), Position(1545, 1015), Color(0, 0, 0),
       SliderParameters(1545, 1905, 1, true));
CREATE(thickness_slider, Slider, Size(5, 30), Position(1545, 595),
       Color(0, 0, 0), SliderParameters(1545, 1905, 1, true));
